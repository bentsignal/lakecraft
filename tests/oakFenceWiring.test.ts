...
assert.match(single, /edit\.block\s*<=\s*BLOCK\.OAK_FENCE/,
  "single-player save validation retains the newest append-only engine ID");
...
assert.doesNotMatch(server, /oak_fence/,
