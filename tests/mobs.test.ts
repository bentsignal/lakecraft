...
assert.deepEqual(Object.keys(MOB_DEFINITIONS).sort(), ["cow", "pig", "sheep", "skeleton", "zombie"]);
...
assert.deepEqual(new Set(spawns.map((spawn) => spawn.kind)), new Set(["pig", "cow", "sheep", "zombie", "skeleton"]));
