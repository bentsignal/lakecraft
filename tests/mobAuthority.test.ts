...
assert.deepEqual(validateMobIdentity("spider-5nf-6"), { ok: true, mobId: "spider-5nf-6", kind: "spider" });
assert.deepEqual(validateMobIdentity("chicken-5nf-7"), { ok: true, mobId: "chicken-5nf-7", kind: "chicken" });
