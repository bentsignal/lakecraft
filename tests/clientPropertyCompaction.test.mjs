...
assert.equal(manifestNames.length, 532, "reviewed compatibility boundary changes only intentionally");
...
assert.equal(manifestNames.length, 472 + privateNames.length, "private names cannot shadow the legacy manifest");
