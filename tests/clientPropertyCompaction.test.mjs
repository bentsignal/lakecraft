...
assert.equal(manifestNames.length, 554, "reviewed compatibility boundary changes only intentionally");
...
assert.equal(manifestNames.length, 490 + privateNames.length, "private names cannot shadow the reviewed public candidate manifest");
