...
assert.equal(manifestNames.length, 595, "reviewed compatibility boundary changes only intentionally");
assert.equal(
  createHash("sha256").update(JSON.stringify(COMPACT_CLIENT_PROPERTY_MANGLE_CACHE)).digest("hex"),
  "f3211d48430fcd728c608aa5607848304e0446abb773694020f69cf7e6f31cd1",
...
assert.equal(manifestNames.length, 531 + privateNames.length, "private names cannot shadow the reviewed public candidate manifest");
