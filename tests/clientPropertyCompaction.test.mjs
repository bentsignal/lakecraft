...
assert.equal(
  ...
  "85fc9087ab3cad553b1d1efc092db338ef3f3a8f90ac5e27457c5ba9724fb9b2",
...
assert.equal(manifestNames.length, 608 + privateNames.length, "private names cannot shadow the reviewed public candidate manifest");
