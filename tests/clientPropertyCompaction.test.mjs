...
assert.equal(manifestNames.length, 643, "reviewed compatibility boundary changes only intentionally");
assert.equal(
  createHash("sha256").update(JSON.stringify(COMPACT_CLIENT_PROPERTY_MANGLE_CACHE)).digest("hex"),
  "b95aab1e3fe6fc93bd4dbecf17f0c4b2aeb6061b773ea8f7450a3df70651c19a",
...
assert.equal(manifestNames.length, 597 + privateNames.length, "private names cannot shadow the reviewed public candidate manifest");
