...
assert.ok(firstPerson.includes("<ItemIcon compact"), "tools, food, materials, and thin placeables keep their pixel sprites");
...
assert.ok(styles.includes("height: clamp(136px,18vw,190px)"), "held cube remains large and responsive without unbounded viewport scaling");
