...
assert.equal(COMPACT_CLIENT_HUMAN_GAME_SCREENSHOT_DELTA.previousOccurrences
  + COMPACT_CLIENT_HUMAN_GAME_SCREENSHOT_DELTA.occurrenceDelta, COMPACT_CLIENT_HUMAN_STRING_OCCURRENCES);
assert.equal(COMPACT_CLIENT_HUMAN_GAME_SCREENSHOT_DELTA.previousUniqueValues
  + COMPACT_CLIENT_HUMAN_GAME_SCREENSHOT_DELTA.uniqueValueDelta, COMPACT_CLIENT_HUMAN_STRING_UNIQUE_VALUES);
