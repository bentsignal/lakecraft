...
assert.equal(COMPACT_CLIENT_HUMAN_SAVE_WARNING_DELTA.previousOccurrences
  + COMPACT_CLIENT_HUMAN_SAVE_WARNING_DELTA.occurrenceDelta, COMPACT_CLIENT_HUMAN_STRING_OCCURRENCES);
assert.equal(COMPACT_CLIENT_HUMAN_SAVE_WARNING_DELTA.previousUniqueValues
  + COMPACT_CLIENT_HUMAN_SAVE_WARNING_DELTA.uniqueValueDelta, COMPACT_CLIENT_HUMAN_STRING_UNIQUE_VALUES);
