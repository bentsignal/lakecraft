...
assert.equal(COMPACT_CLIENT_HUMAN_WOOD_FAMILY_REGISTRY_DELTA.previousOccurrences
  + COMPACT_CLIENT_HUMAN_WOOD_FAMILY_REGISTRY_DELTA.occurrenceDelta, COMPACT_CLIENT_HUMAN_STRING_OCCURRENCES);
assert.equal(COMPACT_CLIENT_HUMAN_WOOD_FAMILY_REGISTRY_DELTA.previousUniqueValues
  + COMPACT_CLIENT_HUMAN_WOOD_FAMILY_REGISTRY_DELTA.uniqueValueDelta, COMPACT_CLIENT_HUMAN_STRING_UNIQUE_VALUES);
...
assert.equal(COMPACT_CLIENT_REPEATED_WOOD_FAMILY_REGISTRY_DELTA.previousOccurrences
  + COMPACT_CLIENT_REPEATED_WOOD_FAMILY_REGISTRY_DELTA.occurrenceDelta, COMPACT_CLIENT_REPEATED_STRING_OCCURRENCES);
assert.equal(COMPACT_CLIENT_REPEATED_WOOD_FAMILY_REGISTRY_DELTA.previousUniqueValues
  + COMPACT_CLIENT_REPEATED_WOOD_FAMILY_REGISTRY_DELTA.uniqueValueDelta, COMPACT_CLIENT_REPEATED_STRING_UNIQUE_VALUES);
