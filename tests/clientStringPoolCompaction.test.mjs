...
assert.equal(COMPACT_CLIENT_REPEATED_FLUID_SYSTEM_DELTA.previousOccurrences
  + COMPACT_CLIENT_REPEATED_FLUID_SYSTEM_DELTA.occurrenceDelta, COMPACT_CLIENT_REPEATED_STRING_OCCURRENCES);
assert.equal(COMPACT_CLIENT_REPEATED_FLUID_SYSTEM_DELTA.previousUniqueValues
  + COMPACT_CLIENT_REPEATED_FLUID_SYSTEM_DELTA.uniqueValueDelta, COMPACT_CLIENT_REPEATED_STRING_UNIQUE_VALUES);
