...
assert.equal(COMPACT_CLIENT_HUMAN_WATER_BUFFER_DELTA.previousOccurrences
  + COMPACT_CLIENT_HUMAN_WATER_BUFFER_DELTA.occurrenceDelta, COMPACT_CLIENT_HUMAN_STRING_OCCURRENCES);
assert.equal(COMPACT_CLIENT_HUMAN_WATER_BUFFER_DELTA.previousUniqueValues
  + COMPACT_CLIENT_HUMAN_WATER_BUFFER_DELTA.uniqueValueDelta, COMPACT_CLIENT_HUMAN_STRING_UNIQUE_VALUES);
...
assert.equal(COMPACT_CLIENT_REPEATED_REMOTE_ARMOR_UNIFICATION_DELTA.previousOccurrences
  + COMPACT_CLIENT_REPEATED_REMOTE_ARMOR_UNIFICATION_DELTA.occurrenceDelta, COMPACT_CLIENT_REPEATED_STRING_OCCURRENCES);
assert.equal(COMPACT_CLIENT_REPEATED_REMOTE_ARMOR_UNIFICATION_DELTA.previousUniqueValues
  + COMPACT_CLIENT_REPEATED_REMOTE_ARMOR_UNIFICATION_DELTA.uniqueValueDelta, COMPACT_CLIENT_REPEATED_STRING_UNIQUE_VALUES);
...
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_REMOTE_ARMOR_UNIFICATION_DELTA.previousOccurrences
  + COMPACT_CLIENT_LOW_FREQUENCY_REMOTE_ARMOR_UNIFICATION_DELTA.occurrenceDelta, COMPACT_CLIENT_LOW_FREQUENCY_STRING_OCCURRENCES);
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_REMOTE_ARMOR_UNIFICATION_DELTA.previousUniqueValues
  + COMPACT_CLIENT_LOW_FREQUENCY_REMOTE_ARMOR_UNIFICATION_DELTA.uniqueValueDelta, COMPACT_CLIENT_LOW_FREQUENCY_STRING_UNIQUE_VALUES);
