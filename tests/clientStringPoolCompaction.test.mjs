...
assert.equal(COMPACT_CLIENT_HUMAN_HUD_SIZE_DELTA.previousOccurrences
  + COMPACT_CLIENT_HUMAN_HUD_SIZE_DELTA.occurrenceDelta, COMPACT_CLIENT_HUMAN_STRING_OCCURRENCES);
assert.equal(COMPACT_CLIENT_HUMAN_HUD_SIZE_DELTA.previousUniqueValues
  + COMPACT_CLIENT_HUMAN_HUD_SIZE_DELTA.uniqueValueDelta, COMPACT_CLIENT_HUMAN_STRING_UNIQUE_VALUES);
...
assert.equal(COMPACT_CLIENT_REPEATED_HUD_SIZE_DELTA.previousOccurrences
  + COMPACT_CLIENT_REPEATED_HUD_SIZE_DELTA.occurrenceDelta, COMPACT_CLIENT_REPEATED_STRING_OCCURRENCES);
assert.equal(COMPACT_CLIENT_REPEATED_HUD_SIZE_DELTA.previousUniqueValues
  + COMPACT_CLIENT_REPEATED_HUD_SIZE_DELTA.uniqueValueDelta, COMPACT_CLIENT_REPEATED_STRING_UNIQUE_VALUES);
...
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_SETTINGS_OBJECT_DELTA.previousOccurrences
  + COMPACT_CLIENT_LOW_FREQUENCY_SETTINGS_OBJECT_DELTA.occurrenceDelta, COMPACT_CLIENT_LOW_FREQUENCY_STRING_OCCURRENCES);
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_SETTINGS_OBJECT_DELTA.previousUniqueValues
  + COMPACT_CLIENT_LOW_FREQUENCY_SETTINGS_OBJECT_DELTA.uniqueValueDelta, COMPACT_CLIENT_LOW_FREQUENCY_STRING_UNIQUE_VALUES);
