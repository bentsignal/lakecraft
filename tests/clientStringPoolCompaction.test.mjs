...
import {
  ...
  COMPACT_CLIENT_FIXED_FREQUENCY_TWO_POSE_LAB_DELTA,
  ...
  COMPACT_CLIENT_FIXED_IDENTITY_POSE_LAB_DELTA,
  ...
  COMPACT_CLIENT_HUMAN_POSE_LAB_DELTA,
  ...
  COMPACT_CLIENT_LOW_FREQUENCY_POSE_LAB_DELTA,
  ...
  COMPACT_CLIENT_REPEATED_POSE_LAB_DELTA,
...
assert.equal(
  COMPACT_CLIENT_FIXED_FREQUENCY_TWO_SOURCE_FINGERPRINT,
  "a6fc7624f03420077f30539bb3093ee02243034699b77e9baf82b8154ec11ad5",
...
assert.equal(COMPACT_CLIENT_FIXED_FREQUENCY_TWO_TITLE_DELTA.previousOccurrences
  ...
  COMPACT_CLIENT_FIXED_FREQUENCY_TWO_POSE_LAB_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_FIXED_FREQUENCY_TWO_TITLE_DELTA.previousUniqueValues
  ...
  COMPACT_CLIENT_FIXED_FREQUENCY_TWO_POSE_LAB_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_FIXED_FREQUENCY_TWO_POSE_LAB_DELTA, {
...
assert.equal(COMPACT_CLIENT_FIXED_FREQUENCY_TWO_POSE_LAB_DELTA.previousOccurrences
  + COMPACT_CLIENT_FIXED_FREQUENCY_TWO_POSE_LAB_DELTA.occurrenceDelta,
COMPACT_CLIENT_FIXED_FREQUENCY_TWO_OCCURRENCES);
assert.equal(COMPACT_CLIENT_FIXED_FREQUENCY_TWO_POSE_LAB_DELTA.previousUniqueValues
  + COMPACT_CLIENT_FIXED_FREQUENCY_TWO_POSE_LAB_DELTA.uniqueValueDelta,
COMPACT_CLIENT_FIXED_FREQUENCY_TWO_UNIQUE_VALUES);
...
assert.equal(COMPACT_CLIENT_FIXED_IDENTITY_SOURCE_FINGERPRINT,
  "ffcfae052dd788a9318b3bef135f5afc537de699474bac90a53353c555c982f5",
...
COMPACT_CLIENT_FIXED_IDENTITY_POSE_LAB_DELTA.previousOccurrences);
assert.deepEqual(COMPACT_CLIENT_FIXED_IDENTITY_POSE_LAB_DELTA, {
  previousOccurrences: 63,
  previousUniqueValues: 7,
...
assert.equal(COMPACT_CLIENT_FIXED_IDENTITY_POSE_LAB_DELTA.previousOccurrences
  + COMPACT_CLIENT_FIXED_IDENTITY_POSE_LAB_DELTA.occurrenceDelta,
COMPACT_CLIENT_FIXED_IDENTITY_OCCURRENCES);
...
assert.equal(COMPACT_CLIENT_HUMAN_DESTROY_STAGE_DELTA.previousOccurrences
  + COMPACT_CLIENT_HUMAN_DESTROY_STAGE_DELTA.occurrenceDelta, COMPACT_CLIENT_HUMAN_POSE_LAB_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_HUMAN_DESTROY_STAGE_DELTA.previousUniqueValues
  + COMPACT_CLIENT_HUMAN_DESTROY_STAGE_DELTA.uniqueValueDelta, COMPACT_CLIENT_HUMAN_POSE_LAB_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_HUMAN_POSE_LAB_DELTA, {
  previousOccurrences: 544,
  previousUniqueValues: 479,
...
assert.equal(COMPACT_CLIENT_HUMAN_POSE_LAB_DELTA.previousOccurrences
  + COMPACT_CLIENT_HUMAN_POSE_LAB_DELTA.occurrenceDelta, COMPACT_CLIENT_HUMAN_STRING_OCCURRENCES);
assert.equal(COMPACT_CLIENT_HUMAN_POSE_LAB_DELTA.previousUniqueValues
  + COMPACT_CLIENT_HUMAN_POSE_LAB_DELTA.uniqueValueDelta, COMPACT_CLIENT_HUMAN_STRING_UNIQUE_VALUES);
...
assert.equal(COMPACT_CLIENT_REPEATED_PICKUP_BIOME_DELTA.previousOccurrences
  + COMPACT_CLIENT_REPEATED_PICKUP_BIOME_DELTA.occurrenceDelta, COMPACT_CLIENT_REPEATED_POSE_LAB_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_REPEATED_PICKUP_BIOME_DELTA.previousUniqueValues
  + COMPACT_CLIENT_REPEATED_PICKUP_BIOME_DELTA.uniqueValueDelta, COMPACT_CLIENT_REPEATED_POSE_LAB_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_REPEATED_POSE_LAB_DELTA, {
...
assert.equal(COMPACT_CLIENT_REPEATED_POSE_LAB_DELTA.previousOccurrences
  + COMPACT_CLIENT_REPEATED_POSE_LAB_DELTA.occurrenceDelta, COMPACT_CLIENT_REPEATED_STRING_OCCURRENCES);
assert.equal(COMPACT_CLIENT_REPEATED_POSE_LAB_DELTA.previousUniqueValues
  + COMPACT_CLIENT_REPEATED_POSE_LAB_DELTA.uniqueValueDelta, COMPACT_CLIENT_REPEATED_STRING_UNIQUE_VALUES);
...
COMPACT_CLIENT_LOW_FREQUENCY_POSE_LAB_DELTA.previousOccurrences);
...
COMPACT_CLIENT_LOW_FREQUENCY_POSE_LAB_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_LOW_FREQUENCY_POSE_LAB_DELTA, {
...
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_POSE_LAB_DELTA.previousOccurrences
  + COMPACT_CLIENT_LOW_FREQUENCY_POSE_LAB_DELTA.occurrenceDelta, COMPACT_CLIENT_LOW_FREQUENCY_STRING_OCCURRENCES);
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_POSE_LAB_DELTA.previousUniqueValues
  + COMPACT_CLIENT_LOW_FREQUENCY_POSE_LAB_DELTA.uniqueValueDelta, COMPACT_CLIENT_LOW_FREQUENCY_STRING_UNIQUE_VALUES);
