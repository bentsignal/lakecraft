...
import {
  ...
  COMPACT_CLIENT_FIXED_IDENTITY_CREATIVE_COMMIT_DELTA,
  ...
  COMPACT_CLIENT_HUMAN_COMMAND_SENDER_REMOVAL_DELTA,
  COMPACT_CLIENT_HUMAN_SAVE_WARNING_DELTA,
  COMPACT_CLIENT_HUMAN_QUIT_RECOVERY_COPY_DELTA,
  ...
  COMPACT_CLIENT_HUMAN_CHAT_SEND_REMOVAL_DELTA,
  COMPACT_CLIENT_HUMAN_HUD_SIZE_DELTA,
  COMPACT_CLIENT_HUMAN_MINECRAFT_PARITY_DELTA,
  COMPACT_CLIENT_HUMAN_RAILWAY_AUTHORITY_DELTA,
  COMPACT_CLIENT_HUMAN_EMBEDDED_ATLAS_DELTA,
  ...
  COMPACT_CLIENT_HUMAN_SURVIVAL_FEEDBACK_DELTA,
  COMPACT_CLIENT_HUMAN_ITEM_CONSERVATION_DELTA,
  COMPACT_CLIENT_HUMAN_TERRAIN_PRESET_DELTA,
  COMPACT_CLIENT_HUMAN_TITLE_HOTBAR_DELTA,
  COMPACT_CLIENT_HUMAN_WATER_BUFFER_DELTA,
  ...
  COMPACT_CLIENT_LOW_FREQUENCY_HUD_CHAT_REFINEMENT_DELTA,
  COMPACT_CLIENT_LOW_FREQUENCY_SETTINGS_OBJECT_DELTA,
  COMPACT_CLIENT_LOW_FREQUENCY_ARMOR_TEXTURE_DELTA,
  COMPACT_CLIENT_LOW_FREQUENCY_REMOTE_MOB_ASSET_DELTA,
  COMPACT_CLIENT_LOW_FREQUENCY_REMOTE_ARMOR_UNIFICATION_DELTA,
  ...
  COMPACT_CLIENT_LOW_FREQUENCY_SURVIVAL_FEEDBACK_DELTA,
  COMPACT_CLIENT_LOW_FREQUENCY_ITEM_CONSERVATION_DELTA,
  COMPACT_CLIENT_LOW_FREQUENCY_LOCAL_DROP_OWNER_DELTA,
  COMPACT_CLIENT_LOW_FREQUENCY_CREATIVE_PARITY_DELTA,
  COMPACT_CLIENT_LOW_FREQUENCY_SHAPED_ICON_RUNTIME_DELTA,
  COMPACT_CLIENT_LOW_FREQUENCY_BUILDING_CATALOG_DELTA,
  COMPACT_CLIENT_LOW_FREQUENCY_THIN_DOOR_LEAVES_DELTA,
  ...
  COMPACT_CLIENT_LOW_FREQUENCY_TITLE_HOTBAR_DELTA,
  COMPACT_CLIENT_LOW_FREQUENCY_INVENTORY_POLISH_DELTA,
  COMPACT_CLIENT_LOW_FREQUENCY_BIOME_DELTA,
  ...
  COMPACT_CLIENT_REPEATED_SAVE_WARNING_DELTA,
  ...
  COMPACT_CLIENT_REPEATED_HUD_CHAT_REFINEMENT_DELTA,
  COMPACT_CLIENT_REPEATED_ARMOR_TEXTURE_DELTA,
  COMPACT_CLIENT_REPEATED_REMOTE_ARMOR_UNIFICATION_DELTA,
  COMPACT_CLIENT_REPEATED_MINECRAFT_PARITY_DELTA,
  COMPACT_CLIENT_REPEATED_CATALOG_AUTHORITY_DELTA,
  COMPACT_CLIENT_REPEATED_EMBEDDED_ATLAS_DELTA,
  ...
  COMPACT_CLIENT_REPEATED_ITEM_CONSERVATION_DELTA,
  COMPACT_CLIENT_REPEATED_TERRAIN_PRESET_DELTA,
  COMPACT_CLIENT_REPEATED_CREATIVE_PARITY_DELTA,
  COMPACT_CLIENT_REPEATED_SHAPED_ICON_RUNTIME_DELTA,
  COMPACT_CLIENT_REPEATED_BUILDING_CATALOG_DELTA,
  COMPACT_CLIENT_REPEATED_THIN_DOOR_DELTA,
  COMPACT_CLIENT_REPEATED_REMOTE_TEXTURE_DELTA,
  ...
  COMPACT_CLIENT_REPEATED_TITLE_HOTBAR_DELTA,
  COMPACT_CLIENT_REPEATED_INVENTORY_POLISH_DELTA,
  COMPACT_CLIENT_REPEATED_BIOME_DELTA,
...
assert.equal(COMPACT_CLIENT_FIXED_FREQUENCY_TWO_MINECRAFT_PARITY_DELTA.previousOccurrences
  ...
  COMPACT_CLIENT_FIXED_FREQUENCY_TWO_TITLE_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_FIXED_FREQUENCY_TWO_MINECRAFT_PARITY_DELTA.previousUniqueValues
  ...
  COMPACT_CLIENT_FIXED_FREQUENCY_TWO_TITLE_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_FIXED_FREQUENCY_TWO_TITLE_DELTA, {
...
assert.equal(COMPACT_CLIENT_FIXED_FREQUENCY_TWO_TITLE_DELTA.previousOccurrences
  + COMPACT_CLIENT_FIXED_FREQUENCY_TWO_TITLE_DELTA.occurrenceDelta,
  COMPACT_CLIENT_FIXED_FREQUENCY_TWO_MULTIPLAYER_AUTH_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_FIXED_FREQUENCY_TWO_TITLE_DELTA.previousUniqueValues
  + COMPACT_CLIENT_FIXED_FREQUENCY_TWO_TITLE_DELTA.uniqueValueDelta,
  COMPACT_CLIENT_FIXED_FREQUENCY_TWO_MULTIPLAYER_AUTH_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_FIXED_FREQUENCY_TWO_MULTIPLAYER_AUTH_DELTA, {
...
assert.equal(COMPACT_CLIENT_FIXED_IDENTITY_SOURCE_FINGERPRINT,
  "5fd4de55e898da872316f9ca3b21eea35281c59e105da8648aae730da3d7c0a4",
...
COMPACT_CLIENT_FIXED_IDENTITY_CREATIVE_COMMIT_DELTA.previousOccurrences);
assert.deepEqual(COMPACT_CLIENT_FIXED_IDENTITY_CREATIVE_COMMIT_DELTA, {
  previousOccurrences: 63,
  previousUniqueValues: 7,
...
assert.equal(COMPACT_CLIENT_FIXED_IDENTITY_CREATIVE_COMMIT_DELTA.previousOccurrences
  + COMPACT_CLIENT_FIXED_IDENTITY_CREATIVE_COMMIT_DELTA.occurrenceDelta,
COMPACT_CLIENT_FIXED_IDENTITY_OCCURRENCES);
...
COMPACT_CLIENT_HUMAN_SURVIVAL_FEEDBACK_DELTA.previousOccurrences);
...
COMPACT_CLIENT_HUMAN_SURVIVAL_FEEDBACK_DELTA.previousUniqueValues);
assert.equal(COMPACT_CLIENT_HUMAN_SURVIVAL_FEEDBACK_DELTA.previousOccurrences
  + COMPACT_CLIENT_HUMAN_SURVIVAL_FEEDBACK_DELTA.occurrenceDelta,
COMPACT_CLIENT_HUMAN_ITEM_CONSERVATION_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_HUMAN_SURVIVAL_FEEDBACK_DELTA.previousUniqueValues
  + COMPACT_CLIENT_HUMAN_SURVIVAL_FEEDBACK_DELTA.uniqueValueDelta,
COMPACT_CLIENT_HUMAN_ITEM_CONSERVATION_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_HUMAN_ITEM_CONSERVATION_DELTA, {
...
assert.equal(COMPACT_CLIENT_HUMAN_ITEM_CONSERVATION_DELTA.previousOccurrences
  + COMPACT_CLIENT_HUMAN_ITEM_CONSERVATION_DELTA.occurrenceDelta,
COMPACT_CLIENT_HUMAN_TERRAIN_PRESET_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_HUMAN_ITEM_CONSERVATION_DELTA.previousUniqueValues
  + COMPACT_CLIENT_HUMAN_ITEM_CONSERVATION_DELTA.uniqueValueDelta,
COMPACT_CLIENT_HUMAN_TERRAIN_PRESET_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_HUMAN_TERRAIN_PRESET_DELTA, {
...
assert.equal(COMPACT_CLIENT_HUMAN_TERRAIN_PRESET_DELTA.previousOccurrences
  + COMPACT_CLIENT_HUMAN_TERRAIN_PRESET_DELTA.occurrenceDelta,
COMPACT_CLIENT_HUMAN_CHUNK_ADMIN_DELTA.previousOccurrences);
...
assert.deepEqual(COMPACT_CLIENT_HUMAN_EMBEDDED_ATLAS_DELTA, {
...
assert.equal(COMPACT_CLIENT_HUMAN_RAILWAY_AUTHORITY_DELTA.previousOccurrences
  + COMPACT_CLIENT_HUMAN_RAILWAY_AUTHORITY_DELTA.occurrenceDelta,
COMPACT_CLIENT_HUMAN_EMBEDDED_ATLAS_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_HUMAN_RAILWAY_AUTHORITY_DELTA.previousUniqueValues
  + COMPACT_CLIENT_HUMAN_RAILWAY_AUTHORITY_DELTA.uniqueValueDelta,
COMPACT_CLIENT_HUMAN_EMBEDDED_ATLAS_DELTA.previousUniqueValues);
assert.equal(COMPACT_CLIENT_HUMAN_EMBEDDED_ATLAS_DELTA.previousOccurrences
  + COMPACT_CLIENT_HUMAN_EMBEDDED_ATLAS_DELTA.occurrenceDelta,
COMPACT_CLIENT_HUMAN_TITLE_HOTBAR_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_HUMAN_EMBEDDED_ATLAS_DELTA.previousUniqueValues
  + COMPACT_CLIENT_HUMAN_EMBEDDED_ATLAS_DELTA.uniqueValueDelta,
COMPACT_CLIENT_HUMAN_TITLE_HOTBAR_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_HUMAN_TITLE_HOTBAR_DELTA, {
...
assert.equal(COMPACT_CLIENT_HUMAN_TITLE_HOTBAR_DELTA.previousOccurrences
  + COMPACT_CLIENT_HUMAN_TITLE_HOTBAR_DELTA.occurrenceDelta, COMPACT_CLIENT_HUMAN_WATER_BUFFER_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_HUMAN_TITLE_HOTBAR_DELTA.previousUniqueValues
  + COMPACT_CLIENT_HUMAN_TITLE_HOTBAR_DELTA.uniqueValueDelta, COMPACT_CLIENT_HUMAN_WATER_BUFFER_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_HUMAN_WATER_BUFFER_DELTA, {
  previousOccurrences: 540,
...
assert.equal(COMPACT_CLIENT_HUMAN_WATER_BUFFER_DELTA.previousOccurrences
  + COMPACT_CLIENT_HUMAN_WATER_BUFFER_DELTA.occurrenceDelta, COMPACT_CLIENT_HUMAN_HUD_SIZE_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_HUMAN_WATER_BUFFER_DELTA.previousUniqueValues
  + COMPACT_CLIENT_HUMAN_WATER_BUFFER_DELTA.uniqueValueDelta, COMPACT_CLIENT_HUMAN_HUD_SIZE_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_HUMAN_HUD_SIZE_DELTA, {
  previousOccurrences: 541,
  previousUniqueValues: 476,
...
assert.equal(COMPACT_CLIENT_HUMAN_HUD_SIZE_DELTA.previousOccurrences
  + COMPACT_CLIENT_HUMAN_HUD_SIZE_DELTA.occurrenceDelta, COMPACT_CLIENT_HUMAN_CHAT_SEND_REMOVAL_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_HUMAN_HUD_SIZE_DELTA.previousUniqueValues
  + COMPACT_CLIENT_HUMAN_HUD_SIZE_DELTA.uniqueValueDelta, COMPACT_CLIENT_HUMAN_CHAT_SEND_REMOVAL_DELTA.previousUniqueValues);
assert.equal(COMPACT_CLIENT_HUMAN_CHAT_SEND_REMOVAL_DELTA.previousOccurrences
  + COMPACT_CLIENT_HUMAN_CHAT_SEND_REMOVAL_DELTA.occurrenceDelta, COMPACT_CLIENT_HUMAN_FLUID_SYSTEM_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_HUMAN_CHAT_SEND_REMOVAL_DELTA.previousUniqueValues
  + COMPACT_CLIENT_HUMAN_CHAT_SEND_REMOVAL_DELTA.uniqueValueDelta, COMPACT_CLIENT_HUMAN_FLUID_SYSTEM_DELTA.previousUniqueValues);
assert.equal(COMPACT_CLIENT_HUMAN_FLUID_SYSTEM_DELTA.previousUniqueValues
  + COMPACT_CLIENT_HUMAN_FLUID_SYSTEM_DELTA.uniqueValueDelta,
  COMPACT_CLIENT_HUMAN_DESTROY_STAGE_DELTA.previousUniqueValues);
assert.equal(COMPACT_CLIENT_HUMAN_FLUID_SYSTEM_DELTA.previousOccurrences
  + COMPACT_CLIENT_HUMAN_FLUID_SYSTEM_DELTA.occurrenceDelta,
  COMPACT_CLIENT_HUMAN_DESTROY_STAGE_DELTA.previousOccurrences);
assert.deepEqual(COMPACT_CLIENT_HUMAN_DESTROY_STAGE_DELTA, {
...
assert.equal(COMPACT_CLIENT_HUMAN_DESTROY_STAGE_DELTA.previousOccurrences
  + COMPACT_CLIENT_HUMAN_DESTROY_STAGE_DELTA.occurrenceDelta,
  COMPACT_CLIENT_HUMAN_MULTIPLAYER_AUTH_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_HUMAN_DESTROY_STAGE_DELTA.previousUniqueValues
  + COMPACT_CLIENT_HUMAN_DESTROY_STAGE_DELTA.uniqueValueDelta,
  COMPACT_CLIENT_HUMAN_MULTIPLAYER_AUTH_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_HUMAN_MULTIPLAYER_AUTH_DELTA, {
  previousOccurrences: 544,
  previousUniqueValues: 479,
...
assert.equal(COMPACT_CLIENT_HUMAN_CHAT_NOTIFICATION_DELTA.previousOccurrences
  + COMPACT_CLIENT_HUMAN_CHAT_NOTIFICATION_DELTA.occurrenceDelta, COMPACT_CLIENT_HUMAN_SAVE_WARNING_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_HUMAN_CHAT_NOTIFICATION_DELTA.previousUniqueValues
  + COMPACT_CLIENT_HUMAN_CHAT_NOTIFICATION_DELTA.uniqueValueDelta, COMPACT_CLIENT_HUMAN_SAVE_WARNING_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_HUMAN_SAVE_WARNING_DELTA, {
  previousOccurrences: 545,
  previousUniqueValues: 477,
...
assert.equal(COMPACT_CLIENT_HUMAN_SAVE_WARNING_DELTA.previousOccurrences
  + COMPACT_CLIENT_HUMAN_SAVE_WARNING_DELTA.occurrenceDelta, COMPACT_CLIENT_HUMAN_QUIT_RECOVERY_COPY_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_HUMAN_SAVE_WARNING_DELTA.previousUniqueValues
  + COMPACT_CLIENT_HUMAN_SAVE_WARNING_DELTA.uniqueValueDelta, COMPACT_CLIENT_HUMAN_QUIT_RECOVERY_COPY_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_HUMAN_QUIT_RECOVERY_COPY_DELTA, {
...
assert.equal(COMPACT_CLIENT_HUMAN_QUIT_RECOVERY_COPY_DELTA.previousOccurrences
  + COMPACT_CLIENT_HUMAN_QUIT_RECOVERY_COPY_DELTA.occurrenceDelta, COMPACT_CLIENT_HUMAN_COMMAND_SENDER_REMOVAL_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_HUMAN_QUIT_RECOVERY_COPY_DELTA.previousUniqueValues
  + COMPACT_CLIENT_HUMAN_QUIT_RECOVERY_COPY_DELTA.uniqueValueDelta, COMPACT_CLIENT_HUMAN_COMMAND_SENDER_REMOVAL_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_HUMAN_COMMAND_SENDER_REMOVAL_DELTA, {
  previousOccurrences: 547,
  previousUniqueValues: 479,
...
assert.equal(COMPACT_CLIENT_HUMAN_COMMAND_SENDER_REMOVAL_DELTA.previousOccurrences
  + COMPACT_CLIENT_HUMAN_COMMAND_SENDER_REMOVAL_DELTA.occurrenceDelta + 15, COMPACT_CLIENT_HUMAN_STRING_OCCURRENCES,
  "review registration and production-world isolation add fifteen distinct user-facing strings");
assert.equal(COMPACT_CLIENT_HUMAN_COMMAND_SENDER_REMOVAL_DELTA.previousUniqueValues
  + COMPACT_CLIENT_HUMAN_COMMAND_SENDER_REMOVAL_DELTA.uniqueValueDelta + 15, COMPACT_CLIENT_HUMAN_STRING_UNIQUE_VALUES);
...
COMPACT_CLIENT_REPEATED_ITEM_CONSERVATION_DELTA.previousOccurrences);
...
COMPACT_CLIENT_REPEATED_ITEM_CONSERVATION_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_REPEATED_ITEM_CONSERVATION_DELTA, {
  previousOccurrences: 1_018,
  previousUniqueValues: 97,
...
assert.equal(COMPACT_CLIENT_REPEATED_ITEM_CONSERVATION_DELTA.previousOccurrences
  + COMPACT_CLIENT_REPEATED_ITEM_CONSERVATION_DELTA.occurrenceDelta,
COMPACT_CLIENT_REPEATED_TERRAIN_PRESET_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_REPEATED_ITEM_CONSERVATION_DELTA.previousUniqueValues
  + COMPACT_CLIENT_REPEATED_ITEM_CONSERVATION_DELTA.uniqueValueDelta,
COMPACT_CLIENT_REPEATED_TERRAIN_PRESET_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_REPEATED_TERRAIN_PRESET_DELTA, {
  previousOccurrences: 1_023,
  previousUniqueValues: 98,
  previousSourceFingerprint: "187bcbf970d8c8c562f25f947ea1a6487772f1184e833b541b28355b09bb607e",
  occurrenceDelta: 3,
  uniqueValueDelta: 0,
  valueDeltas: { default: 1, error: 2 },
  source: "client/realtimeMultiplayer.ts#terrain-preset-handshake",
  exclusionChanges: 0,
});
assert.equal(COMPACT_CLIENT_REPEATED_TERRAIN_PRESET_DELTA.previousOccurrences
  + COMPACT_CLIENT_REPEATED_TERRAIN_PRESET_DELTA.occurrenceDelta,
COMPACT_CLIENT_REPEATED_CREATIVE_PARITY_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_REPEATED_TERRAIN_PRESET_DELTA.previousUniqueValues
  + COMPACT_CLIENT_REPEATED_TERRAIN_PRESET_DELTA.uniqueValueDelta,
COMPACT_CLIENT_REPEATED_CREATIVE_PARITY_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_REPEATED_CREATIVE_PARITY_DELTA, {
...
assert.equal(COMPACT_CLIENT_REPEATED_CREATIVE_PARITY_DELTA.previousOccurrences
  + COMPACT_CLIENT_REPEATED_CREATIVE_PARITY_DELTA.occurrenceDelta,
COMPACT_CLIENT_REPEATED_SHAPED_ICON_RUNTIME_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_REPEATED_CREATIVE_PARITY_DELTA.previousUniqueValues
  + COMPACT_CLIENT_REPEATED_CREATIVE_PARITY_DELTA.uniqueValueDelta,
COMPACT_CLIENT_REPEATED_SHAPED_ICON_RUNTIME_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_REPEATED_SHAPED_ICON_RUNTIME_DELTA, {
...
assert.equal(COMPACT_CLIENT_REPEATED_SHAPED_ICON_RUNTIME_DELTA.previousOccurrences
  + COMPACT_CLIENT_REPEATED_SHAPED_ICON_RUNTIME_DELTA.occurrenceDelta,
COMPACT_CLIENT_REPEATED_BUILDING_CATALOG_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_REPEATED_SHAPED_ICON_RUNTIME_DELTA.previousUniqueValues
  + COMPACT_CLIENT_REPEATED_SHAPED_ICON_RUNTIME_DELTA.uniqueValueDelta,
COMPACT_CLIENT_REPEATED_BUILDING_CATALOG_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_REPEATED_BUILDING_CATALOG_DELTA, {
...
assert.equal(COMPACT_CLIENT_REPEATED_BUILDING_CATALOG_DELTA.previousOccurrences
  + COMPACT_CLIENT_REPEATED_BUILDING_CATALOG_DELTA.occurrenceDelta,
COMPACT_CLIENT_REPEATED_THIN_DOOR_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_REPEATED_BUILDING_CATALOG_DELTA.previousUniqueValues
  + COMPACT_CLIENT_REPEATED_BUILDING_CATALOG_DELTA.uniqueValueDelta,
COMPACT_CLIENT_REPEATED_THIN_DOOR_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_REPEATED_THIN_DOOR_DELTA, {
  ...
  occurrenceDelta: 5,
  uniqueValueDelta: 1,
  valueDeltas: { "_door_": 5 },
  source: "client/game/skyExposure.ts#closed-directional-doors-remain-thin",
  exclusionChanges: 0,
});
assert.equal(COMPACT_CLIENT_REPEATED_THIN_DOOR_DELTA.previousOccurrences
  + COMPACT_CLIENT_REPEATED_THIN_DOOR_DELTA.occurrenceDelta,
COMPACT_CLIENT_REPEATED_REMOTE_TEXTURE_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_REPEATED_THIN_DOOR_DELTA.previousUniqueValues
  + COMPACT_CLIENT_REPEATED_THIN_DOOR_DELTA.uniqueValueDelta,
COMPACT_CLIENT_REPEATED_REMOTE_TEXTURE_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_REPEATED_REMOTE_TEXTURE_DELTA, {
...
assert.deepEqual(COMPACT_CLIENT_REPEATED_EMBEDDED_ATLAS_DELTA, {
...
assert.equal(COMPACT_CLIENT_REPEATED_CATALOG_AUTHORITY_DELTA.previousOccurrences
  + COMPACT_CLIENT_REPEATED_CATALOG_AUTHORITY_DELTA.occurrenceDelta,
COMPACT_CLIENT_REPEATED_EMBEDDED_ATLAS_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_REPEATED_CATALOG_AUTHORITY_DELTA.previousUniqueValues
  + COMPACT_CLIENT_REPEATED_CATALOG_AUTHORITY_DELTA.uniqueValueDelta,
COMPACT_CLIENT_REPEATED_EMBEDDED_ATLAS_DELTA.previousUniqueValues);
assert.equal(COMPACT_CLIENT_REPEATED_EMBEDDED_ATLAS_DELTA.previousOccurrences
  + COMPACT_CLIENT_REPEATED_EMBEDDED_ATLAS_DELTA.occurrenceDelta,
COMPACT_CLIENT_REPEATED_TITLE_HOTBAR_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_REPEATED_EMBEDDED_ATLAS_DELTA.previousUniqueValues
  + COMPACT_CLIENT_REPEATED_EMBEDDED_ATLAS_DELTA.uniqueValueDelta,
COMPACT_CLIENT_REPEATED_TITLE_HOTBAR_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_REPEATED_TITLE_HOTBAR_DELTA, {
  previousOccurrences: 1_339,
  previousUniqueValues: 133,
...
assert.equal(COMPACT_CLIENT_REPEATED_TITLE_HOTBAR_DELTA.previousOccurrences
  + COMPACT_CLIENT_REPEATED_TITLE_HOTBAR_DELTA.occurrenceDelta,
COMPACT_CLIENT_REPEATED_INVENTORY_POLISH_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_REPEATED_TITLE_HOTBAR_DELTA.previousUniqueValues
  + COMPACT_CLIENT_REPEATED_TITLE_HOTBAR_DELTA.uniqueValueDelta,
COMPACT_CLIENT_REPEATED_INVENTORY_POLISH_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_REPEATED_INVENTORY_POLISH_DELTA, {
...
assert.equal(COMPACT_CLIENT_REPEATED_INVENTORY_POLISH_DELTA.previousOccurrences
  + COMPACT_CLIENT_REPEATED_INVENTORY_POLISH_DELTA.occurrenceDelta,
COMPACT_CLIENT_REPEATED_BIOME_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_REPEATED_INVENTORY_POLISH_DELTA.previousUniqueValues
  + COMPACT_CLIENT_REPEATED_INVENTORY_POLISH_DELTA.uniqueValueDelta,
COMPACT_CLIENT_REPEATED_BIOME_DELTA.previousUniqueValues);
assert.equal(COMPACT_CLIENT_REPEATED_BIOME_DELTA.previousOccurrences
  + COMPACT_CLIENT_REPEATED_BIOME_DELTA.occurrenceDelta, COMPACT_CLIENT_REPEATED_ARMOR_TEXTURE_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_REPEATED_BIOME_DELTA.previousUniqueValues
  + COMPACT_CLIENT_REPEATED_BIOME_DELTA.uniqueValueDelta, COMPACT_CLIENT_REPEATED_ARMOR_TEXTURE_DELTA.previousUniqueValues);
assert.equal(COMPACT_CLIENT_REPEATED_ARMOR_TEXTURE_DELTA.previousOccurrences
  + COMPACT_CLIENT_REPEATED_ARMOR_TEXTURE_DELTA.occurrenceDelta,
COMPACT_CLIENT_REPEATED_REMOTE_ARMOR_UNIFICATION_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_REPEATED_ARMOR_TEXTURE_DELTA.previousUniqueValues
  + COMPACT_CLIENT_REPEATED_ARMOR_TEXTURE_DELTA.uniqueValueDelta,
COMPACT_CLIENT_REPEATED_REMOTE_ARMOR_UNIFICATION_DELTA.previousUniqueValues);
assert.equal(COMPACT_CLIENT_REPEATED_REMOTE_ARMOR_UNIFICATION_DELTA.previousOccurrences
  + COMPACT_CLIENT_REPEATED_REMOTE_ARMOR_UNIFICATION_DELTA.occurrenceDelta, COMPACT_CLIENT_REPEATED_HUD_SIZE_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_REPEATED_REMOTE_ARMOR_UNIFICATION_DELTA.previousUniqueValues
  + COMPACT_CLIENT_REPEATED_REMOTE_ARMOR_UNIFICATION_DELTA.uniqueValueDelta, COMPACT_CLIENT_REPEATED_HUD_SIZE_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_REPEATED_HUD_SIZE_DELTA, {
...
assert.equal(COMPACT_CLIENT_REPEATED_HUD_SIZE_DELTA.previousOccurrences
  + COMPACT_CLIENT_REPEATED_HUD_SIZE_DELTA.occurrenceDelta, COMPACT_CLIENT_REPEATED_HUD_CHAT_REFINEMENT_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_REPEATED_HUD_SIZE_DELTA.previousUniqueValues
  + COMPACT_CLIENT_REPEATED_HUD_SIZE_DELTA.uniqueValueDelta, COMPACT_CLIENT_REPEATED_HUD_CHAT_REFINEMENT_DELTA.previousUniqueValues);
assert.equal(COMPACT_CLIENT_REPEATED_HUD_CHAT_REFINEMENT_DELTA.previousOccurrences
  + COMPACT_CLIENT_REPEATED_HUD_CHAT_REFINEMENT_DELTA.occurrenceDelta, COMPACT_CLIENT_REPEATED_FLUID_SYSTEM_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_REPEATED_HUD_CHAT_REFINEMENT_DELTA.previousUniqueValues
  + COMPACT_CLIENT_REPEATED_HUD_CHAT_REFINEMENT_DELTA.uniqueValueDelta, COMPACT_CLIENT_REPEATED_FLUID_SYSTEM_DELTA.previousUniqueValues);
assert.equal(COMPACT_CLIENT_REPEATED_FLUID_SYSTEM_DELTA.previousOccurrences
  + COMPACT_CLIENT_REPEATED_FLUID_SYSTEM_DELTA.occurrenceDelta,
COMPACT_CLIENT_REPEATED_PICKUP_BIOME_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_REPEATED_FLUID_SYSTEM_DELTA.previousUniqueValues
  + COMPACT_CLIENT_REPEATED_FLUID_SYSTEM_DELTA.uniqueValueDelta,
COMPACT_CLIENT_REPEATED_PICKUP_BIOME_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_REPEATED_PICKUP_BIOME_DELTA, {
...
assert.equal(COMPACT_CLIENT_REPEATED_PICKUP_BIOME_DELTA.previousOccurrences
  + COMPACT_CLIENT_REPEATED_PICKUP_BIOME_DELTA.occurrenceDelta,
  COMPACT_CLIENT_REPEATED_MULTIPLAYER_AUTH_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_REPEATED_PICKUP_BIOME_DELTA.previousUniqueValues
  + COMPACT_CLIENT_REPEATED_PICKUP_BIOME_DELTA.uniqueValueDelta,
  COMPACT_CLIENT_REPEATED_MULTIPLAYER_AUTH_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_REPEATED_MULTIPLAYER_AUTH_DELTA, {
...
assert.equal(COMPACT_CLIENT_REPEATED_CHAT_NOTIFICATION_DELTA.previousOccurrences
  + COMPACT_CLIENT_REPEATED_CHAT_NOTIFICATION_DELTA.occurrenceDelta, COMPACT_CLIENT_REPEATED_SAVE_WARNING_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_REPEATED_CHAT_NOTIFICATION_DELTA.previousUniqueValues
  + COMPACT_CLIENT_REPEATED_CHAT_NOTIFICATION_DELTA.uniqueValueDelta, COMPACT_CLIENT_REPEATED_SAVE_WARNING_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_REPEATED_SAVE_WARNING_DELTA, {
...
assert.equal(COMPACT_CLIENT_REPEATED_SAVE_WARNING_DELTA.previousOccurrences
  + COMPACT_CLIENT_REPEATED_SAVE_WARNING_DELTA.occurrenceDelta + 16, COMPACT_CLIENT_REPEATED_STRING_OCCURRENCES);
assert.equal(COMPACT_CLIENT_REPEATED_SAVE_WARNING_DELTA.previousUniqueValues
  + COMPACT_CLIENT_REPEATED_SAVE_WARNING_DELTA.uniqueValueDelta + 1, COMPACT_CLIENT_REPEATED_STRING_UNIQUE_VALUES);
...
COMPACT_CLIENT_LOW_FREQUENCY_SURVIVAL_FEEDBACK_DELTA.previousOccurrences);
...
COMPACT_CLIENT_LOW_FREQUENCY_SURVIVAL_FEEDBACK_DELTA.previousUniqueValues);
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_SURVIVAL_FEEDBACK_DELTA.previousOccurrences
  + COMPACT_CLIENT_LOW_FREQUENCY_SURVIVAL_FEEDBACK_DELTA.occurrenceDelta,
COMPACT_CLIENT_LOW_FREQUENCY_ITEM_CONSERVATION_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_SURVIVAL_FEEDBACK_DELTA.previousUniqueValues
  + COMPACT_CLIENT_LOW_FREQUENCY_SURVIVAL_FEEDBACK_DELTA.uniqueValueDelta,
COMPACT_CLIENT_LOW_FREQUENCY_ITEM_CONSERVATION_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_LOW_FREQUENCY_ITEM_CONSERVATION_DELTA, {
...
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_ITEM_CONSERVATION_DELTA.previousOccurrences
  + COMPACT_CLIENT_LOW_FREQUENCY_ITEM_CONSERVATION_DELTA.occurrenceDelta,
COMPACT_CLIENT_LOW_FREQUENCY_LOCAL_DROP_OWNER_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_ITEM_CONSERVATION_DELTA.previousUniqueValues
  + COMPACT_CLIENT_LOW_FREQUENCY_ITEM_CONSERVATION_DELTA.uniqueValueDelta,
COMPACT_CLIENT_LOW_FREQUENCY_LOCAL_DROP_OWNER_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_LOW_FREQUENCY_LOCAL_DROP_OWNER_DELTA, {
  previousOccurrences: 420,
  previousUniqueValues: 124,
...
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_LOCAL_DROP_OWNER_DELTA.previousOccurrences
  + COMPACT_CLIENT_LOW_FREQUENCY_LOCAL_DROP_OWNER_DELTA.occurrenceDelta,
COMPACT_CLIENT_LOW_FREQUENCY_CREATIVE_PARITY_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_LOCAL_DROP_OWNER_DELTA.previousUniqueValues
  + COMPACT_CLIENT_LOW_FREQUENCY_LOCAL_DROP_OWNER_DELTA.uniqueValueDelta,
COMPACT_CLIENT_LOW_FREQUENCY_CREATIVE_PARITY_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_LOW_FREQUENCY_CREATIVE_PARITY_DELTA, {
  previousOccurrences: 422,
  previousUniqueValues: 124,
...
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_CREATIVE_PARITY_DELTA.previousOccurrences
  + COMPACT_CLIENT_LOW_FREQUENCY_CREATIVE_PARITY_DELTA.occurrenceDelta,
COMPACT_CLIENT_LOW_FREQUENCY_SHAPED_ICON_RUNTIME_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_CREATIVE_PARITY_DELTA.previousUniqueValues
  + COMPACT_CLIENT_LOW_FREQUENCY_CREATIVE_PARITY_DELTA.uniqueValueDelta,
COMPACT_CLIENT_LOW_FREQUENCY_SHAPED_ICON_RUNTIME_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_LOW_FREQUENCY_SHAPED_ICON_RUNTIME_DELTA, {
...
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_SHAPED_ICON_RUNTIME_DELTA.previousOccurrences
  + COMPACT_CLIENT_LOW_FREQUENCY_SHAPED_ICON_RUNTIME_DELTA.occurrenceDelta,
COMPACT_CLIENT_LOW_FREQUENCY_BUILDING_CATALOG_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_SHAPED_ICON_RUNTIME_DELTA.previousUniqueValues
  + COMPACT_CLIENT_LOW_FREQUENCY_SHAPED_ICON_RUNTIME_DELTA.uniqueValueDelta,
COMPACT_CLIENT_LOW_FREQUENCY_BUILDING_CATALOG_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_LOW_FREQUENCY_BUILDING_CATALOG_DELTA, {
...
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_BUILDING_CATALOG_DELTA.previousOccurrences
  + COMPACT_CLIENT_LOW_FREQUENCY_BUILDING_CATALOG_DELTA.occurrenceDelta,
COMPACT_CLIENT_LOW_FREQUENCY_THIN_DOOR_LEAVES_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_BUILDING_CATALOG_DELTA.previousUniqueValues
  + COMPACT_CLIENT_LOW_FREQUENCY_BUILDING_CATALOG_DELTA.uniqueValueDelta,
COMPACT_CLIENT_LOW_FREQUENCY_THIN_DOOR_LEAVES_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_LOW_FREQUENCY_THIN_DOOR_LEAVES_DELTA, {
  ...
  occurrenceDelta: -1,
  uniqueValueDelta: 0,
  valueDeltas: { "_door_": -4, "_leaves": 3 },
...
COMPACT_CLIENT_LOW_FREQUENCY_REMOTE_MOB_ASSET_DELTA.previousOccurrences);
...
COMPACT_CLIENT_LOW_FREQUENCY_REMOTE_MOB_ASSET_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_LOW_FREQUENCY_REMOTE_MOB_ASSET_DELTA, {
...
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_REMOTE_MOB_ASSET_DELTA.previousOccurrences
  + COMPACT_CLIENT_LOW_FREQUENCY_REMOTE_MOB_ASSET_DELTA.occurrenceDelta,
COMPACT_CLIENT_LOW_FREQUENCY_TITLE_HOTBAR_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_REMOTE_MOB_ASSET_DELTA.previousUniqueValues
  + COMPACT_CLIENT_LOW_FREQUENCY_REMOTE_MOB_ASSET_DELTA.uniqueValueDelta,
COMPACT_CLIENT_LOW_FREQUENCY_TITLE_HOTBAR_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_LOW_FREQUENCY_TITLE_HOTBAR_DELTA, {
...
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_TITLE_HOTBAR_DELTA.previousOccurrences
  + COMPACT_CLIENT_LOW_FREQUENCY_TITLE_HOTBAR_DELTA.occurrenceDelta,
COMPACT_CLIENT_LOW_FREQUENCY_INVENTORY_POLISH_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_TITLE_HOTBAR_DELTA.previousUniqueValues
  + COMPACT_CLIENT_LOW_FREQUENCY_TITLE_HOTBAR_DELTA.uniqueValueDelta,
COMPACT_CLIENT_LOW_FREQUENCY_INVENTORY_POLISH_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_LOW_FREQUENCY_INVENTORY_POLISH_DELTA, {
...
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_INVENTORY_POLISH_DELTA.previousOccurrences
  + COMPACT_CLIENT_LOW_FREQUENCY_INVENTORY_POLISH_DELTA.occurrenceDelta,
COMPACT_CLIENT_LOW_FREQUENCY_BIOME_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_INVENTORY_POLISH_DELTA.previousUniqueValues
  + COMPACT_CLIENT_LOW_FREQUENCY_INVENTORY_POLISH_DELTA.uniqueValueDelta,
COMPACT_CLIENT_LOW_FREQUENCY_BIOME_DELTA.previousUniqueValues);
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_BIOME_DELTA.previousOccurrences
  + COMPACT_CLIENT_LOW_FREQUENCY_BIOME_DELTA.occurrenceDelta, COMPACT_CLIENT_LOW_FREQUENCY_ARMOR_TEXTURE_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_BIOME_DELTA.previousUniqueValues
  + COMPACT_CLIENT_LOW_FREQUENCY_BIOME_DELTA.uniqueValueDelta, COMPACT_CLIENT_LOW_FREQUENCY_ARMOR_TEXTURE_DELTA.previousUniqueValues);
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_ARMOR_TEXTURE_DELTA.previousOccurrences
  + COMPACT_CLIENT_LOW_FREQUENCY_ARMOR_TEXTURE_DELTA.occurrenceDelta,
COMPACT_CLIENT_LOW_FREQUENCY_REMOTE_ARMOR_UNIFICATION_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_ARMOR_TEXTURE_DELTA.previousUniqueValues
  + COMPACT_CLIENT_LOW_FREQUENCY_ARMOR_TEXTURE_DELTA.uniqueValueDelta,
COMPACT_CLIENT_LOW_FREQUENCY_REMOTE_ARMOR_UNIFICATION_DELTA.previousUniqueValues);
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_REMOTE_ARMOR_UNIFICATION_DELTA.previousOccurrences
  + COMPACT_CLIENT_LOW_FREQUENCY_REMOTE_ARMOR_UNIFICATION_DELTA.occurrenceDelta, COMPACT_CLIENT_LOW_FREQUENCY_HUD_SIZE_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_REMOTE_ARMOR_UNIFICATION_DELTA.previousUniqueValues
  + COMPACT_CLIENT_LOW_FREQUENCY_REMOTE_ARMOR_UNIFICATION_DELTA.uniqueValueDelta, COMPACT_CLIENT_LOW_FREQUENCY_HUD_SIZE_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_LOW_FREQUENCY_HUD_SIZE_DELTA, {
...
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_HUD_SIZE_DELTA.previousOccurrences
  + COMPACT_CLIENT_LOW_FREQUENCY_HUD_SIZE_DELTA.occurrenceDelta, COMPACT_CLIENT_LOW_FREQUENCY_SETTINGS_OBJECT_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_HUD_SIZE_DELTA.previousUniqueValues
  + COMPACT_CLIENT_LOW_FREQUENCY_HUD_SIZE_DELTA.uniqueValueDelta, COMPACT_CLIENT_LOW_FREQUENCY_SETTINGS_OBJECT_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_LOW_FREQUENCY_SETTINGS_OBJECT_DELTA, {
...
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_SETTINGS_OBJECT_DELTA.previousOccurrences
  + COMPACT_CLIENT_LOW_FREQUENCY_SETTINGS_OBJECT_DELTA.occurrenceDelta, COMPACT_CLIENT_LOW_FREQUENCY_HUD_CHAT_REFINEMENT_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_SETTINGS_OBJECT_DELTA.previousUniqueValues
  + COMPACT_CLIENT_LOW_FREQUENCY_SETTINGS_OBJECT_DELTA.uniqueValueDelta, COMPACT_CLIENT_LOW_FREQUENCY_HUD_CHAT_REFINEMENT_DELTA.previousUniqueValues);
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_HUD_CHAT_REFINEMENT_DELTA.previousOccurrences
  + COMPACT_CLIENT_LOW_FREQUENCY_HUD_CHAT_REFINEMENT_DELTA.occurrenceDelta, COMPACT_CLIENT_LOW_FREQUENCY_FLUID_SYSTEM_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_HUD_CHAT_REFINEMENT_DELTA.previousUniqueValues
  + COMPACT_CLIENT_LOW_FREQUENCY_HUD_CHAT_REFINEMENT_DELTA.uniqueValueDelta, COMPACT_CLIENT_LOW_FREQUENCY_FLUID_SYSTEM_DELTA.previousUniqueValues);
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_FLUID_SYSTEM_DELTA.previousOccurrences
  + COMPACT_CLIENT_LOW_FREQUENCY_FLUID_SYSTEM_DELTA.occurrenceDelta, COMPACT_CLIENT_LOW_FREQUENCY_CUTOUT_LEAVES_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_FLUID_SYSTEM_DELTA.previousUniqueValues
  + COMPACT_CLIENT_LOW_FREQUENCY_FLUID_SYSTEM_DELTA.uniqueValueDelta, COMPACT_CLIENT_LOW_FREQUENCY_CUTOUT_LEAVES_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_LOW_FREQUENCY_CUTOUT_LEAVES_DELTA, {
  previousOccurrences: 607,
  previousUniqueValues: 180,
...
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_CUTOUT_LEAVES_DELTA.previousOccurrences
  + COMPACT_CLIENT_LOW_FREQUENCY_CUTOUT_LEAVES_DELTA.occurrenceDelta,
COMPACT_CLIENT_LOW_FREQUENCY_MULTIPLAYER_AUTH_DELTA.previousOccurrences);
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_CUTOUT_LEAVES_DELTA.previousUniqueValues
  + COMPACT_CLIENT_LOW_FREQUENCY_CUTOUT_LEAVES_DELTA.uniqueValueDelta,
COMPACT_CLIENT_LOW_FREQUENCY_MULTIPLAYER_AUTH_DELTA.previousUniqueValues);
assert.deepEqual(COMPACT_CLIENT_LOW_FREQUENCY_MULTIPLAYER_AUTH_DELTA, {
...
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_CHAT_NOTIFICATION_DELTA.previousOccurrences
  + COMPACT_CLIENT_LOW_FREQUENCY_CHAT_NOTIFICATION_DELTA.occurrenceDelta - 2,
  COMPACT_CLIENT_LOW_FREQUENCY_STRING_OCCURRENCES);
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_CHAT_NOTIFICATION_DELTA.previousUniqueValues
  + COMPACT_CLIENT_LOW_FREQUENCY_CHAT_NOTIFICATION_DELTA.uniqueValueDelta - 1,
  COMPACT_CLIENT_LOW_FREQUENCY_STRING_UNIQUE_VALUES);
