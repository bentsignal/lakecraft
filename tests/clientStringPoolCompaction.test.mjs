...
assert.equal(COMPACT_CLIENT_HUMAN_TITLE_HOTBAR_DELTA.previousOccurrences
  + COMPACT_CLIENT_HUMAN_TITLE_HOTBAR_DELTA.occurrenceDelta, COMPACT_CLIENT_HUMAN_STRING_OCCURRENCES);
assert.equal(COMPACT_CLIENT_HUMAN_TITLE_HOTBAR_DELTA.previousUniqueValues
  + COMPACT_CLIENT_HUMAN_TITLE_HOTBAR_DELTA.uniqueValueDelta, COMPACT_CLIENT_HUMAN_STRING_UNIQUE_VALUES);
