...
assert.equal(COMPACT_CLIENT_HUMAN_COMMAND_SENDER_REMOVAL_DELTA.previousOccurrences
  + COMPACT_CLIENT_HUMAN_COMMAND_SENDER_REMOVAL_DELTA.occurrenceDelta, COMPACT_CLIENT_HUMAN_STRING_OCCURRENCES);
assert.equal(COMPACT_CLIENT_HUMAN_COMMAND_SENDER_REMOVAL_DELTA.previousUniqueValues
  + COMPACT_CLIENT_HUMAN_COMMAND_SENDER_REMOVAL_DELTA.uniqueValueDelta, COMPACT_CLIENT_HUMAN_STRING_UNIQUE_VALUES);
...
assert.equal(COMPACT_CLIENT_REPEATED_SAVE_WARNING_DELTA.previousOccurrences
  + COMPACT_CLIENT_REPEATED_SAVE_WARNING_DELTA.occurrenceDelta, COMPACT_CLIENT_REPEATED_STRING_OCCURRENCES);
assert.equal(COMPACT_CLIENT_REPEATED_SAVE_WARNING_DELTA.previousUniqueValues
  + COMPACT_CLIENT_REPEATED_SAVE_WARNING_DELTA.uniqueValueDelta, COMPACT_CLIENT_REPEATED_STRING_UNIQUE_VALUES);
