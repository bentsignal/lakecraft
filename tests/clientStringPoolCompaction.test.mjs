...
assert.equal(COMPACT_CLIENT_FIXED_IDENTITY_SOURCE_FINGERPRINT,
  "fb0b5d59a8aefe3a8accf8b36c4df74723d4a4d4ffdf1e816aaa2a3ef55f0690",
...
assert.equal(COMPACT_CLIENT_HUMAN_CHAT_SEND_REMOVAL_DELTA.previousOccurrences
  + COMPACT_CLIENT_HUMAN_CHAT_SEND_REMOVAL_DELTA.occurrenceDelta, COMPACT_CLIENT_HUMAN_STRING_OCCURRENCES);
assert.equal(COMPACT_CLIENT_HUMAN_CHAT_SEND_REMOVAL_DELTA.previousUniqueValues
  + COMPACT_CLIENT_HUMAN_CHAT_SEND_REMOVAL_DELTA.uniqueValueDelta, COMPACT_CLIENT_HUMAN_STRING_UNIQUE_VALUES);
...
assert.equal(COMPACT_CLIENT_REPEATED_HUD_CHAT_REFINEMENT_DELTA.previousOccurrences
  + COMPACT_CLIENT_REPEATED_HUD_CHAT_REFINEMENT_DELTA.occurrenceDelta, COMPACT_CLIENT_REPEATED_STRING_OCCURRENCES);
assert.equal(COMPACT_CLIENT_REPEATED_HUD_CHAT_REFINEMENT_DELTA.previousUniqueValues
  + COMPACT_CLIENT_REPEATED_HUD_CHAT_REFINEMENT_DELTA.uniqueValueDelta, COMPACT_CLIENT_REPEATED_STRING_UNIQUE_VALUES);
...
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_HUD_CHAT_REFINEMENT_DELTA.previousOccurrences
  + COMPACT_CLIENT_LOW_FREQUENCY_HUD_CHAT_REFINEMENT_DELTA.occurrenceDelta, COMPACT_CLIENT_LOW_FREQUENCY_STRING_OCCURRENCES);
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_HUD_CHAT_REFINEMENT_DELTA.previousUniqueValues
  + COMPACT_CLIENT_LOW_FREQUENCY_HUD_CHAT_REFINEMENT_DELTA.uniqueValueDelta, COMPACT_CLIENT_LOW_FREQUENCY_STRING_UNIQUE_VALUES);
