...
assert.equal(COMPACT_CLIENT_HUMAN_QUIT_RECOVERY_COPY_DELTA.previousOccurrences
  + COMPACT_CLIENT_HUMAN_QUIT_RECOVERY_COPY_DELTA.occurrenceDelta, COMPACT_CLIENT_HUMAN_STRING_OCCURRENCES);
assert.equal(COMPACT_CLIENT_HUMAN_QUIT_RECOVERY_COPY_DELTA.previousUniqueValues
  + COMPACT_CLIENT_HUMAN_QUIT_RECOVERY_COPY_DELTA.uniqueValueDelta, COMPACT_CLIENT_HUMAN_STRING_UNIQUE_VALUES);
