...
assert.equal(fixedFrequencyTwoValues.length, 62, "the reviewed long frequency-two pool stays exact");
...
assert.equal(
  COMPACT_CLIENT_FIXED_FREQUENCY_TWO_SOURCE_FINGERPRINT,
  "dee0ce7f3ce28c9c9f951c5e1d14fa496b28498c150417914e736165eddb9d00",
...
assert.equal(COMPACT_CLIENT_HUMAN_DESTROY_STAGE_DELTA.previousOccurrences
  + COMPACT_CLIENT_HUMAN_DESTROY_STAGE_DELTA.occurrenceDelta, COMPACT_CLIENT_HUMAN_STRING_OCCURRENCES);
assert.equal(COMPACT_CLIENT_HUMAN_DESTROY_STAGE_DELTA.previousUniqueValues
  + COMPACT_CLIENT_HUMAN_DESTROY_STAGE_DELTA.uniqueValueDelta, COMPACT_CLIENT_HUMAN_STRING_UNIQUE_VALUES);
...
assert.equal(COMPACT_CLIENT_REPEATED_PICKUP_BIOME_DELTA.previousOccurrences
  + COMPACT_CLIENT_REPEATED_PICKUP_BIOME_DELTA.occurrenceDelta, COMPACT_CLIENT_REPEATED_STRING_OCCURRENCES);
assert.equal(COMPACT_CLIENT_REPEATED_PICKUP_BIOME_DELTA.previousUniqueValues
  + COMPACT_CLIENT_REPEATED_PICKUP_BIOME_DELTA.uniqueValueDelta, COMPACT_CLIENT_REPEATED_STRING_UNIQUE_VALUES);
...
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_CUTOUT_LEAVES_DELTA.previousOccurrences
  + COMPACT_CLIENT_LOW_FREQUENCY_CUTOUT_LEAVES_DELTA.occurrenceDelta, COMPACT_CLIENT_LOW_FREQUENCY_STRING_OCCURRENCES);
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_CUTOUT_LEAVES_DELTA.previousUniqueValues
  + COMPACT_CLIENT_LOW_FREQUENCY_CUTOUT_LEAVES_DELTA.uniqueValueDelta, COMPACT_CLIENT_LOW_FREQUENCY_STRING_UNIQUE_VALUES);
