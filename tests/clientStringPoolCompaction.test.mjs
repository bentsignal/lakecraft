...
assert.equal(COMPACT_CLIENT_HUMAN_EMBEDDED_ATLAS_DELTA.previousOccurrences
  + COMPACT_CLIENT_HUMAN_EMBEDDED_ATLAS_DELTA.occurrenceDelta, COMPACT_CLIENT_HUMAN_STRING_OCCURRENCES);
assert.equal(COMPACT_CLIENT_HUMAN_EMBEDDED_ATLAS_DELTA.previousUniqueValues
  + COMPACT_CLIENT_HUMAN_EMBEDDED_ATLAS_DELTA.uniqueValueDelta, COMPACT_CLIENT_HUMAN_STRING_UNIQUE_VALUES);
...
assert.equal(COMPACT_CLIENT_REPEATED_EMBEDDED_ATLAS_DELTA.previousOccurrences
  + COMPACT_CLIENT_REPEATED_EMBEDDED_ATLAS_DELTA.occurrenceDelta, COMPACT_CLIENT_REPEATED_STRING_OCCURRENCES);
assert.equal(COMPACT_CLIENT_REPEATED_EMBEDDED_ATLAS_DELTA.previousUniqueValues
  + COMPACT_CLIENT_REPEATED_EMBEDDED_ATLAS_DELTA.uniqueValueDelta, COMPACT_CLIENT_REPEATED_STRING_UNIQUE_VALUES);
