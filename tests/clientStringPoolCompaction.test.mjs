...
assert.equal(COMPACT_CLIENT_REPEATED_BIOME_DELTA.previousOccurrences
  + COMPACT_CLIENT_REPEATED_BIOME_DELTA.occurrenceDelta, COMPACT_CLIENT_REPEATED_STRING_OCCURRENCES);
assert.equal(COMPACT_CLIENT_REPEATED_BIOME_DELTA.previousUniqueValues
  + COMPACT_CLIENT_REPEATED_BIOME_DELTA.uniqueValueDelta, COMPACT_CLIENT_REPEATED_STRING_UNIQUE_VALUES);
...
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_BIOME_DELTA.previousOccurrences
  + COMPACT_CLIENT_LOW_FREQUENCY_BIOME_DELTA.occurrenceDelta, COMPACT_CLIENT_LOW_FREQUENCY_STRING_OCCURRENCES);
assert.equal(COMPACT_CLIENT_LOW_FREQUENCY_BIOME_DELTA.previousUniqueValues
  + COMPACT_CLIENT_LOW_FREQUENCY_BIOME_DELTA.uniqueValueDelta, COMPACT_CLIENT_LOW_FREQUENCY_STRING_UNIQUE_VALUES);
