...
The current focused benchmark run measured radius-40 terrain generation at 16.08 ms, one million day/night samples at 91.84 ms, 384,000 mob simulation ticks at 23.1 ms, and 50 nearest-light selections across 10,000 torch candidates at 18.11 ms. Doors and beds add fixed-size custom meshes; sleep voting and world-clock updates are event-driven and do not add a frame-loop query or mutation.
