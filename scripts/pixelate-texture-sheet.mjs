...
function paintDerivedTile(output, outputIndex, columns, tileSize, name) {
  ...
  if (/^(oak_door_|(?:spruce|birch|jungle|acacia|dark_oak|mangrove|cherry)_(?:log|log_end|planks|leaves|door_)|bamboo_|quartz_|chiseled_quartz|granite|polished_granite|diorite|polished_diorite|andesite|polished_andesite|sandstone|cut_sandstone|chiseled_sandstone|smooth_stone|calcite|deepslate|cobbled_deepslate|polished_deepslate|deepslate_bricks|deepslate_tiles|(?:white|orange|magenta|light_blue|yellow|lime|pink|gray|light_gray|cyan|purple|blue|brown|green|red|black)_(?:stained_glass|concrete|wool|terracotta|glazed_terracotta)|glowstone|sea_lantern|shroomlight|(?:ochre|verdant|pearlescent)_froglight_|magma_block|mossy_|cracked_|chiseled_stone_|packed_mud|mud_bricks|prismarine|dark_prismarine|nether_bricks|red_nether_bricks|blackstone|polished_blackstone|end_stone|purpur_block|obsidian|crying_obsidian|(?:cut_|chiseled_)?red_sandstone|smooth_sandstone|smooth_red_sandstone|amethyst_block|budding_amethyst|tuff|polished_tuff|tuff_bricks|resin_bricks|dripstone_block|copper_block|exposed_copper|weathered_copper|oxidized_copper|cut_copper|exposed_cut_copper|weathered_cut_copper|oxidized_cut_copper|sculk|nether_wart_block)/.test(name)) {
