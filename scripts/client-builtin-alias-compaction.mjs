...
const PROPERTY_ALIAS_COUNT_OVERRIDES = Object.freeze({
  ...
  command: 16, createBuffer: 25, current: 869, currentTarget: 19, cycleLengthMs: 20, dayNight: 9, delete: 85, deleteBuffer: 43,
  ...
  getItem: 22, getUniformLocation: 69, health: 55, height: 35, includes: 54, inventory: 105, itemId: 182, length: 490,
  ...
  remainder: 17, sequence: 47, setTimeout: 21, sheared: 16, slice: 103, sourceSlot: 10, startsWith: 36,
...
export const COMPACT_CLIENT_PROPERTY_KEY_OCCURRENCES = 6_451;
export const COMPACT_CLIENT_PROPERTY_KEY_FINGERPRINT = "91180833e31c833369689bfbe491811184213243299d49f2a4db7db9421a3d2a";
...
const GLOBAL_ALIAS_SPEC = "Float32Array:87,Map:75,Set:70,Uint8Array:21,document:99,performance:79,window:140";
...
export const COMPACT_CLIENT_GLOBAL_OCCURRENCES = 571;
export const COMPACT_CLIENT_GLOBAL_FINGERPRINT = "a30bb97cf01322dd33b8d5b79d6291c873cdc717d43a36a87f99fc098ed07b70";
