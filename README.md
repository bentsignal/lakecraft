...
- `server/index.ts` — Lakebed schema, auth-backed profiles, compact authoritative world chunks, 5 Hz multiplayer presence/chat, CAS-safe inventories, atomic world item drops/pickups, shared-chest transfers, a leased deterministic mob authority, and the synchronized sleep clock
