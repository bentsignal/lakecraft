...
- `client/game/` — custom chunked WebGL renderer, deterministic caves, sand deposits, and ore-bearing terrain, lighting, fixed-buffer Steve avatars, passive mobs, zombies, ranged skeletons, combat, movement, collisions, and raycasting
